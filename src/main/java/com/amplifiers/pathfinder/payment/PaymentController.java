...
public class PaymentController {
    ...
    public ResponseEntity<Void> handlePaymentSuccess(@RequestParam Map<String, String> payload) {
    ...
    public ResponseEntity<String> handlePaymentCancel(@RequestParam Map<String, String> payload) {
    ...
    public ResponseEntity<String> handlePaymentFail(@RequestParam Map<String, String> payload) {
